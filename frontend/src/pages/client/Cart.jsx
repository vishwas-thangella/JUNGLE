...
const Cart = () =>{
    ...
    return(
        <div>
            ...
            <Sidebar/>
            <div className='pt-20'>
                <h1 className='text-center mt-2 uppercase text-xl text-gray-600'>Cart</h1>
                {
                    cartItems.length > 0 ? <div>
                                ...
                                return(
                                    <div className='flex flex-row gap-3 justify-evenly mt-3'>
                                        ...
                                        <div className='flex flex-col gap-1'>
                                            <h1 className=' text-xs md:text-xl textgray-600'>{itm.name}</h1>
                                            <h1 className=' text-xs md:text-xl textgray-600'>{itm.description}</h1>
                                            <h1 className=' text-xs md:text-xl textgray-600'>RS {itm.price} </h1>
                                            <h1 className=' text-xs md:text-xl textgray-600'>SIZE : {itm.size}</h1>
                                        </div>
                        ...
                        <div className='flex flex-row mt-4'>
                            <button className='p-3 text-white bg-black text-base mx-auto' onClick={()=>{
                                if(Auth){
                                    navigate("/checkout");
                                }else{
                                    navigate("/login");
